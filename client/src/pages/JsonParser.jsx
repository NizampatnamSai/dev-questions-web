      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder={"{\n  \"key\": \"value\"\n}"}
            className="w-full h-80 p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 text-slate-700 dark:text-slate-200 font-mono text-sm outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
          />
          {error && (
        ...
        <div className="space-y-2">
          ...
          <textarea
            ...
            className="w-full h-80 p-4 rounded-xl border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 text-slate-700 dark:text-slate-200 font-mono text-sm outline-none resize-none"
          />
        </div>
      </div>
