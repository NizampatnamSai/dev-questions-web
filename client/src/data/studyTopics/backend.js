...
export default [
  ...
  },
  {
    ...
    difficulty: "Basic",
    summary:
      "A mock API server returns realistic fake responses matching an agreed contract, letting frontend development proceed in parallel with backend implementation instead of blocking on it — exactly what a tool like DevQuiz's own Mock API Generator provides.",
    explanation:
